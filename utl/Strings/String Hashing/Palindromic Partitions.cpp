...
/*
	preciso responder continuamente:

	qual maior prefixo de [l, r] que eh tambem sufixo. p function. mas tem que ser mais rapido
*/
...
int solve() {
	...
	for (int a = 0, b = n-1; ; ) {
		int ok = 0, tam = 1;
		for (; a + tam - 1 < b - tam + 1; tam++) {
			ok |= H(a, a + tam - 1) == H(b - tam + 1, b);
			if (ok) break;
		}
